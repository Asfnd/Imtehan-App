...
function InstagramFollowButton({ size = 'md' }: { size?: 'sm' | 'md' }) {
  ...
  return (
    <a
      ...
      className={`group relative inline-flex ${box} shrink-0 items-center justify-center rounded-xl text-white shadow-sm transition-all duration-200 hover:scale-105 hover:shadow-md active:scale-95`}
      style={{
        background:
    ...
    >
      <svg className={`${icon} drop-shadow-sm`} fill="currentColor" viewBox="0 0 24 24" aria-hidden>
