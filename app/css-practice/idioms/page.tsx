...
export default function IdiomsPage() {
  ...
  const startQuiz = (year?: number) => {
    ...
    if (!user) {
      // Use the correct idioms-specific method
      const canAccess = year ? usageTracker.canTakeCSSIdiomsQuiz() : usageTracker.canTakeCSSIdiomsRandom()
          ...
          <div className="bg-black/20 backdrop-blur-xl border-b border-white/10 z-10 shadow-lg">
            <div className="max-w-5xl mx-auto px-4 py-4">
              <div className="flex items-center justify-between">
                ...
                <div className="text-center">
                  <h1 className="text-xl font-bold bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text text-transparent">Official Past CSS MCQS</h1>
                </div>
          ...
          <div className="flex-1 flex items-center justify-center px-4">
            <div className="w-full max-w-6xl mx-auto">
              ...
              <div className="text-center mb-8">
                <h2 className="text-2xl sm:text-3xl font-black bg-gradient-to-r from-purple-300 via-pink-300 to-purple-300 bg-clip-text text-transparent">
                  Past Official English Idioms MCQS
                </h2>
              </div>
