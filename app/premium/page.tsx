      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-base text-gray-600">
            Unlock unlimited access to all competitive exam preparation resources
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-4 lg:gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
              ...
              <Button variant="outline" onClick={scrollToPayment} className="w-full border-2 border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-2.5">
                Select
              </Button>
            </div>

            {/* 12 Months — Best Value (center) */}
            <div className="bg-white rounded-xl border-2 border-blue-500 p-6 shadow-lg relative">
              ...
              <Button onClick={scrollToPayment} className="w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-2.5">
                Get Started
              </Button>
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
              <div className="mb-4">
                ...
                <p className="text-xs text-gray-500">Great for focused prep</p>
              </div>
              <div className="mb-5">
                <div className="flex items-baseline gap-1 mb-1">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-8 shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-3 sm:gap-4">
                  <div className="flex-shrink-0 w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-sm">1</div>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 sm:p-4 hover:border-blue-200 transition-colors overflow-hidden">
                      ...
                      <div className="space-y-2.5">
                        <div className="flex items-start sm:items-center justify-between group gap-2">
                          ...
                          <button onClick={() => copyToClipboard('PK16UNIL0109000339614961', 'iban')} className="flex-shrink-0 p-2 hover:bg-white rounded-lg transition-colors border border-transparent hover:border-gray-200" title="Copy IBAN">
                            {copiedField === 'iban' ? <CheckCircle2 className="w-4 h-4 text-green-600" /> : <Copy className="w-4 h-4 text-gray-400" />}
                          </button>
                        </div>
                        <div className="flex items-start sm:items-center justify-between group gap-2">
                          <div className="flex-1 min-w-0">
                          ...
                          <button onClick={() => copyToClipboard('7804339614961', 'account')} className="flex-shrink-0 p-2 hover:bg-white rounded-lg transition-colors border border-transparent hover:border-gray-200" title="Copy Account Number">
                            {copiedField === 'account' ? <CheckCircle2 className="w-4 h-4 text-green-600" /> : <Copy className="w-4 h-4 text-gray-400" />}
                          </button>
                        </div>
                ...
                {/* Step 2 */}
                <div className="flex gap-3 sm:gap-4">
                  <div className="flex-shrink-0 w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-sm">2</div>
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-700 mt-2.5 flex items-start gap-1.5">
                ...
                {/* Step 3 */}
                <div className="flex gap-3 sm:gap-4">
                  <div className="flex-shrink-0 w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-sm">3</div>
                  <div className="flex-1 min-w-0">
