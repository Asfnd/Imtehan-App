...
const FEATURES = [
  ...
  { text: 'Unlimited practice sets', isNew: false },
  { text: 'All mock tests', isNew: false },
  { text: 'Solved past papers', isNew: false },
  { text: 'Guess papers & model questions', isNew: false },
]
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="pt-10 pb-2 text-center">
        ...
        <p className="text-sm text-gray-500 mt-1.5">All plans include every feature · CSS, MDCAT, FSc, PPSC & more</p>
      </div>
                  ...
                  {FEATURES.map((f) => (
                    <li key={f.text} className="flex items-start gap-2">
                      ...
                      <span className="text-sm text-gray-600 flex items-center gap-1.5 flex-wrap">
                        {f.text}
                        {f.isNew && (
                          <span className="text-[9px] font-black uppercase tracking-wide bg-blue-100 text-blue-600 px-1.5 py-0.5 rounded-full leading-none">New</span>
                        )}
                      </span>
                    </li>
                  ))}
