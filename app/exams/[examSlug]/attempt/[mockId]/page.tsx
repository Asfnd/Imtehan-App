...
async function cachedBuildMockMcqs(examSlug: string, mockNumber: number) {
  // v10: normalized stems + fresh /attempt path (escapes CF-cached /mock-attempt HTML)
  const cached = await unstable_cache(
    () => buildMockMcqs(examSlug, mockNumber),
    [`exam-mock-v10-${examSlug}-${mockNumber}`],
    { revalidate: 86400, tags: [`exam-mock-${examSlug}`, 'exam-mocks-v10'] }
  )()
