  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div
          onClick={() => router.push('/admin/feedback')}
          className="bg-white/90 backdrop-blur-xl rounded-2xl p-6 border-2 border-blue-200 cursor-pointer hover:shadow-xl transition-all hover-scale-sm animate-fade-in"
        >
        ...
        <div
          onClick={() => router.push('/admin/reports')}
          className="bg-white/90 backdrop-blur-xl rounded-2xl p-6 border-2 border-purple-200 cursor-pointer hover:shadow-xl transition-all hover-scale-sm animate-fade-in"
        >
        ...
        <div
          ...
          className="bg-white/90 backdrop-blur-xl rounded-2xl p-6 border-2 border-green-200 cursor-pointer hover:shadow-xl transition-all hover-scale-sm animate-fade-in"
        >
        ...
        {recentActivity.length === 0 ? (
          ...
          <div className="space-y-3 animate-stagger">
            {recentActivity.map((activity) => (
              <div
                key={activity.id}
                className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors animate-slide-left"
              >
