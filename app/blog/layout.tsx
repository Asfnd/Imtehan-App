...
const blogPosts = [
  ...
  },
  {
    ...
    title: '80/20 English Grammar Guide for CSS & MDCAT',
    excerpt: 'Focus on the 20% of grammar rules that appear in 80% of CSS and MDCAT questions. Smart, efficient grammar prep.',
  ...
  },
  {
    ...
    title: 'FSc Board Exam Presentation: How to Write for Maximum Marks',
    excerpt: 'Master answer presentation for FSc board exams. Learn formatting, diagrams, and writing techniques to score higher.',
    date: 'February 20, 2026',
    author: 'Imtehan Team',
    readTime: '9 min read',
    category: 'FSc Guide',
  },
  {
    ...
    title: 'MDCAT Biology Mastery Strategy: Topics, Tips & Practice',
    excerpt: 'Complete MDCAT Biology preparation strategy covering all high-yield topics, common mistakes, and practice techniques.',
    date: 'February 20, 2026',
    author: 'Imtehan Team',
    readTime: '12 min read',
    category: 'MDCAT Guide',
  },
  {
    slug: 'mdcat-physics-shortcuts',
    title: 'MDCAT Physics Shortcuts: High-Yield Topics & Quick Formulas',
    excerpt: 'Learn the most tested MDCAT Physics concepts with shortcuts and quick formulas to maximize your score.',
    date: 'February 20, 2026',
    author: 'Imtehan Team',
    readTime: '11 min read',
    category: 'MDCAT Guide',
  },
  {
    ...
    title: 'PPSC & FPSC General Knowledge Strategy: What Actually Gets Asked',
    excerpt: 'High-yield General Knowledge topics for PPSC and FPSC exams. Focus on what actually appears in the tests.',
    date: 'February 20, 2026',
    author: 'Imtehan Team',
    readTime: '10 min read',
  ...
  },
  {
    ...
    title: 'Smart Guessing in MCQ Exams: When and How to Guess',
    excerpt: 'Evidence-based strategies for intelligent guessing in CSS, MDCAT, and PPSC MCQ exams to maximise your score.',
    date: 'February 20, 2026',
    author: 'Imtehan Team',
    readTime: '8 min read',
    category: 'Strategy',
  },
  {
    ...
    title: 'How Social Studying and Community Chat Boosts Exam Performance',
    excerpt: 'Why studying with a community improves retention, motivation, and results. How to use group study effectively.',
    date: 'February 20, 2026',
    author: 'Imtehan Team',
    readTime: '7 min read',
    category: 'Strategy',
