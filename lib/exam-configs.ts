...
export const EXAM_CONFIGS: Record<string, ExamConfig> = {
  ...
  'hec-law-gat': {
    ...
    negativeMarking: false,
    sections: [
      { slug: 'constitutional-law', label: 'Constitutional Law', dbTable: 'css_mcqs_enhanced', subjectField: 'Constitutional Law', count: 25 },
      { slug: 'law', label: 'Law (Civil & Criminal)', dbTable: 'css_mcqs_enhanced', subjectField: 'Law', count: 25 },
      { slug: 'muslim-law', label: 'Muslim Law & Jurisprudence', dbTable: 'css_mcqs_enhanced', subjectField: 'Muslim Law and Jurisprudence', count: 25 },
      { slug: 'mercantile-law', label: 'Mercantile Law', dbTable: 'css_mcqs_enhanced', subjectField: 'Mercantile Law', count: 25 },
    ],
    guide: {
      authority: 'Higher Education Commission (HEC), Pakistan',
      officialLink: 'https://etc.hec.gov.pk/',
      eligibility: ['LLB graduates seeking enrollment with Pakistan Bar Council and LLM admissions.'],
      important: ['Mandatory for bar enrollment after LLB. Constitutional and criminal law are high-yield areas.'],
      helpful: ['Use past Law-GAT papers alongside constitutional and jurisprudence MCQ banks here.'],
    },
  },
