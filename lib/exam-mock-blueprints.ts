...
const BLUEPRINT_SLUG_ALIASES: Record<string, string> = {
  ...
  'mdcat-etea': 'mdcat-etea',
  'fsc-pre-medical': 'mdcat-core',
  'fsc-pre-engineering': 'ecat',
  'pharm-d-entry': 'mdcat-core',
  'bsn-nursing-entry': 'mdcat-core',
  'dpt-entry': 'mdcat-core',
  'bds-entry': 'mdcat-core',
  'dow-entry': 'mdcat-core',
  'nust-net-medical': 'mdcat-core',
  'shifa-entry': 'mdcat-core',
  'cmh-lahore-entry': 'mdcat-core',
  'pms-punjab': 'pms-competitive',
  'pms-sindh': 'pms-competitive',
  'pms-kpk': 'pms-competitive',
  'pms-balochistan': 'pms-competitive',
  'pms-ajk': 'pms-competitive',
  'pms-gb': 'pms-competitive',
  'ned-entry': 'ecat',
  'pu-cet-lahore': 'ecat',
  'uet-taxila': 'ecat',
  'nts-nat-ia': 'nts-nat-igs',
...
export const OFFICIAL_EXAM_LINKS: Record<string, string> = {
  ...
  'mdcat-pmc':           'https://pmc.gov.pk/',
  'mdcat-uhs':           'https://www.uhs.edu.pk/',
  'mdcat-etea':          'https://www.etea.edu.pk/',
  ...
  'dow-entry':           'https://www.duhs.edu.pk/',
  'nust-net-medical':    'https://www.nust.edu.pk/admissions',
  'shifa-entry':         'https://www.shifa.com.pk/',
  'cmh-lahore-entry':    'https://www.cmh.edu.pk/',
  'ajk-educators':       'https://www.ajkpsc.gov.pk/',
  'ned-entry':           'https://www.neduet.edu.pk/',
  'pu-cet-lahore':       'https://pu.edu.pk/',
  'uet-taxila':          'https://www.uettaxila.edu.pk/',
  'balochistan-educators': 'https://www.bpsc.gob.pk/',
  'gb-educators':        'https://gbpsc.gob.pk/',
  'punjab-educators':    'https://www.ppsc.gop.pk/',
  'tevta-skills-test':   'https://www.tevta.gop.pk/',
  'icap-ca-foundation':  'https://www.icap.org.pk/',
  'kpk-educators-etea':  'https://www.etea.edu.pk/',
  'sindh-educators':     'https://www.sts.net.pk/',
  'nts-nat-ia':          'https://www.nts.org.pk/products/ntsnat/nat-paper-pattern.php',
...
const RESEARCHED: Record<string, MockBlueprint[]> = {
  ...
  'mdcat-etea': [
    {
      key: 'etea', label: 'ETEA MDCAT', durationMin: 150, negMarking: 0.25,
      sections: [
        { slug: 'biology', count: 60 },
        { slug: 'chemistry', count: 60 },
  ...
  'mdcat-nums': [
    {
      key: 'nums', label: 'NUMS MDCAT', durationMin: 165, negMarking: 0,
      sections: [
        { slug: 'biology', count: 60 },
        { slug: 'chemistry', count: 38 },
        { slug: 'physics', count: 37 },
        { slug: 'english', count: 15 },
      ],
    },
  ],
  /** 4-subject medical entry tests (no logical-reasoning section). */
  'mdcat-core': [
    {
      key: 'core', label: 'Medical Sciences Mock', durationMin: 150, negMarking: 0,
      sections: [
        { slug: 'biology', count: 81 },
        { slug: 'chemistry', count: 45 },
        { slug: 'physics', count: 36 },
  ...
  'police-ict-assistant': [
    {
      ...
      sections: [
        ...
        { slug: 'pakistan-affairs', count: 20 },
        { slug: 'general-knowledge', count: 20 },
        { slug: 'computer', count: 20 },
      ],
    },
  ],
  'issb-academic': [
    {
      key: 'academic', label: 'ISSB Academic Screening', durationMin: 90, negMarking: 0,
      sections: [
        { slug: 'english', count: 25 },
        { slug: 'mathematics', count: 25 },
        { slug: 'general-knowledge', count: 20 },
        { slug: 'pakistan-affairs', count: 20 },
        { slug: 'intelligence', count: 10 },
      ],
    },
  ],
  ecat: [
