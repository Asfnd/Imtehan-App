#!/usr/bin/env python3
"""
Extract MCQs from combined PDF with all subjects
Each subject starts on a specific page and questions restart from 1
"""
...
OUTPUT_FOLDER = "/Users/asfandiyarsafi/Desktop/CSS App/Claude/quiz-app/PPSC_Combined_MCQs"
...
def main():
    print("="*60)
    print("EXTRACTING FROM COMBINED PDF")
    print("="*60)
